...
from .export import export_markdown, export_csv_row, export_json
...
def process_pdf(pdf_path: str, out_dir: str):
    ...
    try:
        ...
        csv_path = export_csv_row(summary, os.path.join(out_dir, "csv", "master_table.csv"), stem)
...
def main():
    parser = argparse.ArgumentParser(description="Batch summarize PDFs into template + exports.")
